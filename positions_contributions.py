...
if __name__ == "__main__":
    ...
    The contribution of the position is computed using 
    ...
    parser.add_argument("-z", "--total-col", required=True, type=str, help="the name of the total contribution column.")
    ...
    ax.set_title(f"Positions contribution: {args.target_col.replace('_', ' ')}", loc="left", weight="bold")
